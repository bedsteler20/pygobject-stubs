...
class ContextMenuItem(GObject.InitiallyUnowned):
    ...
    @classmethod
    def new_from_gaction(cls, action: Gio.Action, label: str, target: Optional[GLib.Variant] = None) -> ContextMenuItem: ...
    @classmethod
    def new_from_stock_action(cls, action: ContextMenuAction) -> ContextMenuItem: ...
    @classmethod
    def new_from_stock_action_with_label(cls, action: ContextMenuAction, label: str) -> ContextMenuItem: ...
    @classmethod
...
class CookieManager(GObject.Object):
    ...
    Signals from GObject:
      notify (GParam)
    """
    def add_cookie(self, cookie: Soup.Cookie, cancellable: Optional[Gio.Cancellable] = None, callback: Optional[Callable[..., None]] = None, *user_data: Any) -> None: ...
    def add_cookie_finish(self, result: Gio.AsyncResult) -> bool: ...
    def delete_cookie(self, cookie: Soup.Cookie, cancellable: Optional[Gio.Cancellable] = None, callback: Optional[Callable[..., None]] = None, *user_data: Any) -> None: ...
    def delete_cookie_finish(self, result: Gio.AsyncResult) -> bool: ...
    def get_accept_policy(self, cancellable: Optional[Gio.Cancellable] = None, callback: Optional[Callable[..., None]] = None, *user_data: Any) -> None: ...
    def get_accept_policy_finish(self, result: Gio.AsyncResult) -> CookieAcceptPolicy: ...
    def get_cookies(self, uri: str, cancellable: Optional[Gio.Cancellable] = None, callback: Optional[Callable[..., None]] = None, *user_data: Any) -> None: ...
...
class Credential(GObject.GBoxed):
    ...
    @classmethod
    def new(cls, username: str, password: str, persistence: CredentialPersistence) -> Credential: ...
    @classmethod
    def new_for_certificate(cls, certificate: Optional[Gio.TlsCertificate], persistence: CredentialPersistence) -> Credential: ...
    @classmethod
    def new_for_certificate_pin(cls, pin: str, persistence: CredentialPersistence) -> Credential: ...
...
class FaviconDatabase(GObject.Object):
    ...
    """
    def clear(self) -> None: ...
    def get_favicon(self, page_uri: str, cancellable: Optional[Gio.Cancellable] = None, callback: Optional[Callable[..., None]] = None, *user_data: Any) -> None: ...
...
class GeolocationPosition(GObject.GBoxed):
    ...
    def free(self) -> None: ...
    @classmethod
    def new(cls, latitude: float, longitude: float, accuracy: float) -> GeolocationPosition: ...
...
class InputMethodContext(GObject.Object):
    ...
    def __init__(self, input_hints: InputHints = ...,
                 input_purpose: InputPurpose = ...): ...
...
class InputMethodContextClass(GObject.GPointer):
    ...
    get_preedit: Callable[[InputMethodContext], Tuple[str, list[InputMethodUnderline], int]] = ...
...
class NetworkProxySettings(GObject.GBoxed):
    ...
    def free(self) -> None: ...
    @classmethod
    def new(cls, default_proxy_uri: Optional[str] = None, ignore_hosts: Optional[Sequence[str]] = None) -> NetworkProxySettings: ...
...
class NetworkSession(GObject.Object):
    ...
    def get_itp_summary(self, cancellable: Optional[Gio.Cancellable] = None, callback: Optional[Callable[..., None]] = None, *user_data: Any) -> None: ...
    ...
    @classmethod
    def new(cls, data_directory: Optional[str] = None, cache_directory: Optional[str] = None) -> NetworkSession: ...
    @classmethod
    ...
    def set_proxy_settings(self, proxy_mode: NetworkProxyMode, proxy_settings: Optional[NetworkProxySettings] = None) -> None: ...
...
class PrintOperation(GObject.Object):
    ...
    class Props:
        ...
        web_view: WebView
    props: Props = ...
    def __init__(self, page_setup: Gtk.PageSetup = ...,
                 print_settings: Gtk.PrintSettings = ...,
                 web_view: WebView = ...): ...
    ...
    def run_dialog(self, parent: Optional[Gtk.Window] = None) -> PrintOperationResponse: ...
...
class Settings(GObject.Object):
    ...
    class Props:
        ...
        zoom_text_only: bool
    props: Props = ...
    def __init__(self, allow_file_access_from_file_urls: bool = ...,
                 allow_modal_dialogs: bool = ...,
                 allow_top_navigation_to_data_urls: bool = ...,
                 allow_universal_access_from_file_urls: bool = ...,
                 auto_load_images: bool = ...,
    ...
    def set_media_content_types_requiring_hardware_support(self, content_types: Optional[str] = None) -> None: ...
    ...
    def set_user_agent_with_application_details(self, application_name: Optional[str] = None, application_version: Optional[str] = None) -> None: ...
...
class URISchemeRequest(GObject.Object):
    ...
    Signals from GObject:
      notify (GParam)
    """
    def finish(self, stream: Gio.InputStream, stream_length: int, content_type: Optional[str] = None) -> None: ...
...
class URISchemeResponse(GObject.Object):
    ...
    def set_status(self, status_code: int, reason_phrase: Optional[str] = None) -> None: ...
...
class UserContentFilterStore(GObject.Object):
    ...
    def fetch_identifiers(self, cancellable: Optional[Gio.Cancellable] = None, callback: Optional[Callable[..., None]] = None, *user_data: Any) -> None: ...
    def fetch_identifiers_finish(self, result: Gio.AsyncResult) -> list[str]: ...
    def get_path(self) -> str: ...
    def load(self, identifier: str, cancellable: Optional[Gio.Cancellable] = None, callback: Optional[Callable[..., None]] = None, *user_data: Any) -> None: ...
    def load_finish(self, result: Gio.AsyncResult) -> UserContentFilter: ...
    @classmethod
    def new(cls, storage_path: str) -> UserContentFilterStore: ...
    def remove(self, identifier: str, cancellable: Optional[Gio.Cancellable] = None, callback: Optional[Callable[..., None]] = None, *user_data: Any) -> None: ...
    def remove_finish(self, result: Gio.AsyncResult) -> bool: ...
    def save(self, identifier: str, source: GLib.Bytes, cancellable: Optional[Gio.Cancellable] = None, callback: Optional[Callable[..., None]] = None, *user_data: Any) -> None: ...
    def save_finish(self, result: Gio.AsyncResult) -> UserContentFilter: ...
    def save_from_file(self, identifier: str, file: Gio.File, cancellable: Optional[Gio.Cancellable] = None, callback: Optional[Callable[..., None]] = None, *user_data: Any) -> None: ...
...
class UserContentManager(GObject.Object):
    ...
    def register_script_message_handler(self, name: str, world_name: Optional[str] = None) -> bool: ...
    def register_script_message_handler_with_reply(self, name: str, world_name: str) -> bool: ...
    ...
    def unregister_script_message_handler(self, name: str, world_name: Optional[str] = None) -> None: ...
...
class UserMessage(GObject.InitiallyUnowned):
    ...
    props: Props = ...
    def __init__(self, fd_list: Gio.UnixFDList = ...,
                 name: str = ...,
    ...
    @classmethod
    def new(cls, name: str, parameters: Optional[GLib.Variant] = None) -> UserMessage: ...
    @classmethod
    def new_with_fd_list(cls, name: str, parameters: Optional[GLib.Variant] = None, fd_list: Optional[Gio.UnixFDList] = None) -> UserMessage: ...
...
class UserScript(GObject.GBoxed):
    ...
    """
    @classmethod
    def new(cls, source: str, injected_frames: UserContentInjectedFrames, injection_time: UserScriptInjectionTime, allow_list: Optional[Sequence[str]] = None, block_list: Optional[Sequence[str]] = None) -> UserScript: ...
    @classmethod
    def new_for_world(cls, source: str, injected_frames: UserContentInjectedFrames, injection_time: UserScriptInjectionTime, world_name: str, allow_list: Optional[Sequence[str]] = None, block_list: Optional[Sequence[str]] = None) -> UserScript: ...
...
class UserStyleSheet(GObject.GBoxed):
    ...
    """
    @classmethod
    def new(cls, source: str, injected_frames: UserContentInjectedFrames, level: UserStyleLevel, allow_list: Optional[Sequence[str]] = None, block_list: Optional[Sequence[str]] = None) -> UserStyleSheet: ...
    @classmethod
    def new_for_world(cls, source: str, injected_frames: UserContentInjectedFrames, level: UserStyleLevel, world_name: str, allow_list: Optional[Sequence[str]] = None, block_list: Optional[Sequence[str]] = None) -> UserStyleSheet: ...
...
class WebContext(GObject.Object):
    ...
    props: Props = ...
    def __init__(self, memory_pressure_settings: MemoryPressureSettings = ...,
                 time_zone_override: str = ...): ...
    ...
    def initialize_notification_permissions(self, allowed_origins: list[SecurityOrigin], disallowed_origins: list[SecurityOrigin]) -> None: ...
    def is_automation_allowed(self) -> bool: ...
    @classmethod
    def new(cls) -> WebContext: ...
    def register_uri_scheme(self, scheme: str, callback: Callable[..., None], *user_data: Any) -> None: ...
    ...
    def set_preferred_languages(self, languages: Optional[Sequence[str]] = None) -> None: ...
...
class WebResource(GObject.Object):
    ...
    class Props:
        ...
        uri: str
    props: Props = ...
    def get_data(self, cancellable: Optional[Gio.Cancellable] = None, callback: Optional[Callable[..., None]] = None, *user_data: Any) -> None: ...
...
class WebView(WebViewBase, Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget):
    ...
    priv: WebViewPrivate = ...
    def __init__(self, automation_presentation_type: AutomationBrowsingContextPresentation = ...,
                 camera_capture_state: MediaCaptureState = ...,
                 ...
                 width_request: int = ...,
                 accessible_role: Gtk.AccessibleRole = ...): ...
    def call_async_javascript_function(self, body: str, length: int, arguments: Optional[GLib.Variant] = None, world_name: Optional[str] = None, source_uri: Optional[str] = None, cancellable: Optional[Gio.Cancellable] = None, callback: Optional[Callable[..., None]] = None, *user_data: Any) -> None: ...
    def call_async_javascript_function_finish(self, result: Gio.AsyncResult) -> JavaScriptCore.Value: ...
    def can_execute_editing_command(self, command: str, cancellable: Optional[Gio.Cancellable] = None, callback: Optional[Callable[..., None]] = None, *user_data: Any) -> None: ...
    ...
    def do_decide_policy(self, decision: PolicyDecision, type: PolicyDecisionType) -> bool: ...
    ...
    def do_load_failed(self, load_event: LoadEvent, failing_uri: str, error: GLib.Error) -> bool: ...
    def do_load_failed_with_tls_errors(self, failing_uri: str, certificate: Gio.TlsCertificate, errors: Gio.TlsCertificateFlags) -> bool: ...
    ...
    def do_web_process_terminated(self, reason: WebProcessTerminationReason) -> None: ...
    def download_uri(self, uri: str) -> Download: ...
    def evaluate_javascript(self, script: str, length: int, world_name: Optional[str] = None, source_uri: Optional[str] = None, cancellable: Optional[Gio.Cancellable] = None, callback: Optional[Callable[..., None]] = None, *user_data: Any) -> None: ...
    ...
    def get_snapshot(self, region: SnapshotRegion, options: SnapshotOptions, cancellable: Optional[Gio.Cancellable] = None, callback: Optional[Callable[..., None]] = None, *user_data: Any) -> None: ...
    def get_snapshot_finish(self, result: Gio.AsyncResult) -> Gdk.Texture: ...
    def get_title(self) -> str: ...
    def get_tls_info(self) -> Tuple[bool, Gio.TlsCertificate, Gio.TlsCertificateFlags]: ...
    def get_uri(self) -> str: ...
    ...
    def load_alternate_html(self, content: str, content_uri: str, base_uri: Optional[str] = None) -> None: ...
    def load_bytes(self, bytes: GLib.Bytes, mime_type: Optional[str] = None, encoding: Optional[str] = None, base_uri: Optional[str] = None) -> None: ...
    ...
    def save(self, save_mode: SaveMode, cancellable: Optional[Gio.Cancellable] = None, callback: Optional[Callable[..., None]] = None, *user_data: Any) -> None: ...
    def save_finish(self, result: Gio.AsyncResult) -> Gio.InputStream: ...
    def save_to_file(self, file: Gio.File, save_mode: SaveMode, cancellable: Optional[Gio.Cancellable] = None, callback: Optional[Callable[..., None]] = None, *user_data: Any) -> None: ...
    def save_to_file_finish(self, result: Gio.AsyncResult) -> bool: ...
    def send_message_to_page(self, message: UserMessage, cancellable: Optional[Gio.Cancellable] = None, callback: Optional[Callable[..., None]] = None, *user_data: Any) -> None: ...
    ...
    def set_input_method_context(self, context: Optional[InputMethodContext] = None) -> None: ...
...
class WebViewBase(Gtk.Widget, Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget):
    ...
    def __init__(self, can_focus: bool = ...,
                 can_target: bool = ...,
                 css_classes: Sequence[str] = ...,
                 css_name: str = ...,
                 cursor: Optional[Gdk.Cursor] = ...,
...
class WebViewClass(GObject.GPointer):
    ...
    load_failed_with_tls_errors: Callable[[WebView, str, Gio.TlsCertificate, Gio.TlsCertificateFlags], bool] = ...
...
class WebsiteDataManager(GObject.Object):
    ...
    class Props:
        ...
        is_ephemeral: bool
    props: Props = ...
    def __init__(self, base_cache_directory: str = ...,
                 base_data_directory: str = ...,
                 is_ephemeral: bool = ...): ...
    def clear(self, types: WebsiteDataTypes, timespan: int, cancellable: Optional[Gio.Cancellable] = None, callback: Optional[Callable[..., None]] = None, *user_data: Any) -> None: ...
    def clear_finish(self, result: Gio.AsyncResult) -> bool: ...
    def fetch(self, types: WebsiteDataTypes, cancellable: Optional[Gio.Cancellable] = None, callback: Optional[Callable[..., None]] = None, *user_data: Any) -> None: ...
    ...
    def get_itp_summary_finish(self, result: Gio.AsyncResult) -> list[ITPThirdParty]: ...
    def is_ephemeral(self) -> bool: ...
    def remove(self, types: WebsiteDataTypes, website_data: list[WebsiteData], cancellable: Optional[Gio.Cancellable] = None, callback: Optional[Callable[..., None]] = None, *user_data: Any) -> None: ...
    def remove_finish(self, result: Gio.AsyncResult) -> bool: ...
